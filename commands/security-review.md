...
- **Critical Focus**: Email parameter injection in database queries (DynamoDB)
- **Critical Focus**: Input validation bypasses in authentication flows
...
- **Critical Focus**: Race conditions in check-then-act patterns (especially in auth flows)
- **Critical Focus**: Email enumeration through different error messages
- **Critical Focus**: Authentication token handling and validation bypass
...
- **Memory-Guided Focus**: Don't assume existing code is secure - question everything
- **Memory-Guided Focus**: Systematically trace complete data flows from input to database
...
- **Memory-Guided Focus**: Use systematic security checklists rather than ad-hoc reviews
- **Memory-Guided Focus**: Always check for race conditions in check-then-act patterns
- **Memory-Guided Focus**: Verify error handling consistency across all paths
